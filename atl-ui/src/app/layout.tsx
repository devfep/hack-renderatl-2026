...
export const metadata: Metadata = {
  title: "Atlanta Transit Agent",
  description:
    "Ask a plain question about Atlanta transit and get a real, sourced answer.",
};
...
export default function RootLayout({
  ...
  return (
    // suppressHydrationWarning on <html> too: some extensions (SwiftRead) inject onto
    // <html> rather than <body>, which the scaffold's body-only guard misses.
